...
type Location struct {
	Lat float64 `json:"lat"`//here  `json:"lat"` ==> dont need to write a parse func to transform json object to Lat float64
...
const (
	INDEX = "around"//used to identify the ES is doing job with data that with index "around" project
	TYPE = "post"
	DISTANCE = "200km"
	// Needs to update
	PROJECT_ID = "around20180923"
	BT_INSTANCE = "around-post"
	// Needs to update this URL if you deploy it to cloud.
	ES_URL = "http://35.202.206.6:9200"
)
